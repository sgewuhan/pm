...
public class TaskForm extends PrimaryObject {
	...
	public UserTask getUserTask() {
		return ModelService.createModelObject(UserTask.class,
				getObjectIdValue(F_USER_TASK_ID));
	}
	 ...
	 * @throws Exception
	 */
	public Object getProcessInstanceVarible(String varible, IContext context)
			throws Exception {
		...
		WorkflowProcessInstance process = WorkflowService.getDefault()
				.getProcessInstance(processId, processInstanceId);
