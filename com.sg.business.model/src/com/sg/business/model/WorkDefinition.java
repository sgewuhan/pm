...
public class WorkDefinition extends PrimaryObject {
	...
	public PrimaryObject[] doMoveLeft(IContext context) throws Exception {
		...
		WorkDefinition grandpa = (WorkDefinition) parent.getParentPrimaryObject();
		...
		List<PrimaryObject> grandpaChildren = grandpa.getChildrenWorkDefinition();
	...
	public PrimaryObject[] doMoveRight(IContext context) throws Exception {
		...
		WorkDefinition upperBrother = (WorkDefinition) parentChildren.get(index-1);
		List<PrimaryObject> upperBrotherChildren = upperBrother.getChildrenWorkDefinition();
