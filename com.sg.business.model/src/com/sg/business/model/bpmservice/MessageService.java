...
public  abstract class MessageService extends ServiceProvider{
	...
	public void sendMessage(String messageTitle,String messageContent,List<String> receiverList,IContext context){
		
		Map<String, Message> msgList=new HashMap<String, Message>();
		for(String userId:receiverList){
			msgList.put(userId, null);
			MessageToolkit.appendMessage(msgList,userId,messageTitle,messageContent,null,null,context);
		}
