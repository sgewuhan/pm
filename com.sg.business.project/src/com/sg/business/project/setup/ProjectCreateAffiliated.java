...
//		try {
//			SQLResult result = SQLUtil.SQL_QUERY("budget", "select * from xt");
//			if (!result.isEmpty()) {
//				// 循环构造用户
...
//															budgetvalue)));
//
//							DBCollection project_Col = getCol(IModelConstants.C_PROJECT);
//							project_Col
//									.update(new BasicDBObject().append(
//											Project.F__ID, project_id),
//											new BasicDBObject()
//													.append("$set",
//															new BasicDBObject()
//																	.append(Project.F_PLAN_START,
//																			row.getValue("planstart"))
//																	.append(Project.F_PLAN_FINISH,
//																			row.getValue("planfinish"))
//																	.append(Project.F_ACTUAL_START,
//																			row.getValue("actualstart"))
//																	.append(Project.F_ACTUAL_FINISH,
//																			row.getValue("actualfinish"))
//																	.append(Project.F_LIFECYCLE,
//																			row.getValue("status"))
//
//													));
//
