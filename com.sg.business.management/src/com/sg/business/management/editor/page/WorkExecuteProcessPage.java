...
public class WorkExecuteProcessPage implements IPageDelegator {

	public WorkExecuteProcessPage() {
	}
	...
	public Composite createPageContent(Composite parent,
		...
		ProcessSettingPanel psp = new ProcessSettingPanel(parent,WorkDefinition.F_WF_EXECUTE,workDefinition){
			@Override
