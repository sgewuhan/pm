...
import com.sg.xdeprecated.commons.flow.model.FlowElement;
import com.sg.xdeprecated.commons.flow.model.Transition;
import com.sg.xdeprecated.commons.flow.policies.ActivityDirectEditPolicy;
...
import com.sg.xdeprecated.commons.flow.policies.ActivitySourceEditPolicy;
...
public abstract class ActivityPart extends AbstractGraphicalEditPart implements
	...
	protected void applyGraphResults(CompoundDirectedGraph graph, Map<?, Node> map) {
	...
	public void contributeEdgesToGraph(CompoundDirectedGraph graph, Map<?, Node> map) {
