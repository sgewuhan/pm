...
import com.sg.xdeprecated.commons.flow.figures.SequentialActivityFigure;
...
public class SequentialActivityPart extends StructuredActivityPart {
	...
	/**
	 * @see com.sg.xdeprecated.commons.flow.part.StructuredActivityPart#createFigure()
	 */
	...
	/**
	 * @see com.sg.xdeprecated.commons.flow.part.StructuredActivityPart#getAnchorOffset()
	 */
	int getAnchorOffset() {
		return 15;
	}
