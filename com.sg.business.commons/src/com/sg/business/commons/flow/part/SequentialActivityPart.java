...
import com.sg.business.commons.flow.figures.SequentialActivityFigure;
...
public class SequentialActivityPart extends StructuredActivityPart {
	...
	/**
	 * @see com.sg.business.commons.flow.part.StructuredActivityPart#createFigure()
	 */
	...
	/**
	 * @see com.sg.business.commons.flow.part.StructuredActivityPart#getAnchorOffset()
	 */
	int getAnchorOffset() {
		return 15;
	}
