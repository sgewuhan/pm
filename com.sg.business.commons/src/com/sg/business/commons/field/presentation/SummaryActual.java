...
public class SummaryActual implements IValuePresentation {

	public SummaryActual() {
	}
	...
	public String getPresentValue(IFormPart part) {
		...
		Work work = (Work) data;
		Date ps = work.getActualStart();
		Date pf = work.getActualFinish();
		if (ps != null) {
		...
		// 取工期
		Integer pd = work.getActualDuration();
		text.append("  ");//$NON-NLS-N$
