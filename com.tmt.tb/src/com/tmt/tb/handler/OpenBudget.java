...
public class OpenBudget implements IFieldActionHandler {
	...
	public Object run(IFormPart abstractFieldPart,
		...
		if (po instanceof TaskForm) {
			...
			try {
				String project_id = (String) taskForm.getProcessInstanceVarible("project_id", new CurrentAccountContext());
