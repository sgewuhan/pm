...
public class UserOfChangeApprover extends MasterDetailDataSetFactory {
	private IContext context;
	private User user;

	public UserOfChangeApprover() {
		...
		if (master != null) {
			if (master instanceof TaskForm) {
				...
				try {
					...
					Role role = org.getRole(IRoleConstance.ROLE_CHANGE_APPROVER_ID, Organization.ROLE_SEARCH_UP);
