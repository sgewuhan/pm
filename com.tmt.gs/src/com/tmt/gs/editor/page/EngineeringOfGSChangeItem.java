...
public class EngineeringOfGSChangeItem extends AbstractFormPageDelegator {

	private TableViewer viewer;
	private IContext context;

	public EngineeringOfGSChangeItem() {
	}
	...
	private void createTable(PrimaryObjectEditorInput input,Composite parent) {
		TableConfigurator configurator=(TableConfigurator) Widgets.getTableRegistry().getConfigurator("ec.gsstandlonework"); //$NON-NLS-1$
